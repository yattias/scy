 ...
 */
public class ExtractKeyphrases extends DocumentOperatorSpecification {
...
//		Map<String, Set<String>> stemMapping = document.getFeature(StemTokens.STEM_MAPPING);
	...
	private void defineFeature() {
		if (!Features.getInstance().isFeature(KeywordWorkflowConstants.KEYPHRASES)) {
			Features.getInstance().addFeature(KeywordWorkflowConstants.KEYPHRASES, Set.class);
		}
	}
