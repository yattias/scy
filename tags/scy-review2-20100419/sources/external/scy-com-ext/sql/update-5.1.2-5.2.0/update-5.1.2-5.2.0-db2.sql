alter table Company add homeURL varchar(500);

alter table ExpandoColumn add companyId bigint;
alter table ExpandoColumn add defaultData varchar(500);
...
alter table Role_ add title varchar(500);
...
alter table User_ add reminderQueryQuestion varchar(500);
alter table User_ add reminderQueryAnswer varchar(500);
...
create table WSRPProducer (
	...
	version varchar(75),
	offeredPortlets varchar(500),
	producerProfileMap varchar(75),
	registrationProperties varchar(500),
