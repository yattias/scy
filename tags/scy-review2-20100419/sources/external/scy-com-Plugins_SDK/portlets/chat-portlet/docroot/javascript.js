...
Liferay.Chat.Panel = new Liferay.Class(
	{
...
Liferay.Chat.Conversation = Liferay.Chat.Panel.extend(
	{
		initialize: function(options) {
			...
			instance._stopTypingTask = new Liferay.DelayedTask(instance.setTyping, instance, [false]);
...
Liferay.Chat.Manager = {
	init: function() {
		...
		instance._sendTask = new Liferay.DelayedTask(instance.send, instance);
		...
		instance._updatePresenceTask = new Liferay.DelayedTask(instance._updatePresence, instance);
