...
public abstract class FreestylerFolderLocalServiceBaseImpl
    implements FreestylerFolderLocalService {
    ...
    public FreestylerFolder addFreestylerFolder(
        FreestylerFolder freestylerFolder) throws SystemException {
        freestylerFolder.setNew(true);

        return freestylerFolderPersistence.update(freestylerFolder, false);
    }

    public FreestylerFolder createFreestylerFolder(long folderId) {
        return freestylerFolderPersistence.create(folderId);
    }

    public void deleteFreestylerFolder(long folderId)
        throws PortalException, SystemException {
        freestylerFolderPersistence.remove(folderId);
    }

    public void deleteFreestylerFolder(FreestylerFolder freestylerFolder)
        throws SystemException {
        freestylerFolderPersistence.remove(freestylerFolder);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return freestylerFolderPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public FreestylerFolder getFreestylerFolder(long folderId)
        throws PortalException, SystemException {
        return freestylerFolderPersistence.findByPrimaryKey(folderId);
    }

    public List<FreestylerFolder> getFreestylerFolders(int start, int end)
        throws SystemException {
        return freestylerFolderPersistence.findAll(start, end);
    }

    public int getFreestylerFoldersCount() throws SystemException {
        return freestylerFolderPersistence.countAll();
    }

    public FreestylerFolder updateFreestylerFolder(
        FreestylerFolder freestylerFolder) throws SystemException {
        freestylerFolder.setNew(false);

        return freestylerFolderPersistence.update(freestylerFolder, true);
    }

    public FreestylerFolder updateFreestylerFolder(
        FreestylerFolder freestylerFolder, boolean merge)
        throws SystemException {
        freestylerFolder.setNew(false);

        return freestylerFolderPersistence.update(freestylerFolder, merge);
    }
