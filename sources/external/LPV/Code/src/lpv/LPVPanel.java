...
implements ActionListener, MouseInputListener, MouseWheelListener, HierarchyBoundsListener{
    ...
    private CityTimeScale referenceScale;
    ...
    public LPVPanel(lpv.City c) {
    	...
    	referenceScale = new CityTimeScale();
    	updateScales();
    ...
    */	//add
    	...
    	referenceScale.setStart(sj.get(0).get(0));
    	referenceScale.setEnd(sj.get(sj.size()-1).get(1));
    	referenceScale.setTimeStart(tj.get(0).get(0));
    	referenceScale.setTimeEnd(tj.get(tj.size()-1).get(1));
    	//referenceScale.setTimeScale();
