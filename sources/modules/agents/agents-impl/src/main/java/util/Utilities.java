...
public class Utilities {
  ...
  public static String findElementContent(ArrayList<String> xmlPath, Element element) {
    String text = "";
  ...
  public static String getEloText(IELO elo, ArrayList<String> path, Logger logger) {
  ...
  public static de.fhg.iais.kd.tm.obwious.base.featurecarrier.Document convertTextToDocument(String text) {
    de.fhg.iais.kd.tm.obwious.base.featurecarrier.Document doc = new de.fhg.iais.kd.tm.obwious.base.featurecarrier.Document("id");
