...
public class UserAction {
    ...
    public static final String ACTION_TOOL_GOT_FOCUS = "tool_got_focus";// not defined in
                                                                        // ActionConstants

    public static final String ACTION_TOOL_LOST_FOCUS = "tool_lost_focus";// not defined in
                                                                          // ActionConstants
    ...
    public static final String ACTION_TEXT_INSERTED = "text_inserted";// not defined in
                                                                      // ActionConstants

    public static final String ACTION_TEXT_DELETED = "text_deleted";// not defined in
                                                                    // ActionConstants
