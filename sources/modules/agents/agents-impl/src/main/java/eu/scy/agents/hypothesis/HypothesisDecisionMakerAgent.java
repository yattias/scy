 ...
 * sentences without keyword, 14 sentences containing one keyword, ..., one sentence containing 5 keywords. To evaluate,
 * we sum up the numbers of sentences, called N. Furthermore we score sentences that contain keywords: Sentences without
