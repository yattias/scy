...
public class TextExtractorTest extends AbstractExtractorTest {
    ...
    public void testExtractKeywords() {
        ...
        assertArrayEquals(expectedKeywords, keywords.toArray(new String[0]));
    }
}
