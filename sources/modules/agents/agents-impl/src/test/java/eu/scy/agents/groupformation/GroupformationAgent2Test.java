...
public class GroupformationAgent2Test extends AbstractTestFixture {
	...
	public void testRun() throws TupleSpaceException, InterruptedException {
		this.getActionSpace().write(this.login("user1", MISSION1, Mission.MISSION1.getName(), "en", "co2"));
		this.getActionSpace().write(this.login("user2", MISSION1, Mission.MISSION1.getName(), "en", "co2"));
		this.getActionSpace().write(this.login("user3", MISSION1, Mission.MISSION1.getName(), "en", "co2"));
