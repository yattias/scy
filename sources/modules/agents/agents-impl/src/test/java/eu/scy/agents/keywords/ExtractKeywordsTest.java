...
public class ExtractKeywordsTest extends AbstractTestFixture {
  ...
  private static final String MISSION = "co2";

  String[] expectedKeywords = new String[] { "VOC content", "used as solvent", "solvent",
                                            "labels", "paint", "voc", "natural paints",
                                            "natural paint", "modern paints", "chemical paints",
                                            "nontoxic", "ingredients", "paint companies",
                                            "still contain", "Natural paints",
                                            "Environmentally Friendly", "chemical", "toxic",
                                            "conventional paint companies", "natural",
  ...
  public void testRun() throws TupleSpaceException {
    ...
    this.getCommandSpace().write(new Tuple(ExtractKeywordsAgent.EXTRACT_KEYWORDS,
                                           AgentProtocol.QUERY, queryId.toString(), TEXT, MISSION));
