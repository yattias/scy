...
public final class AgentProtocol {
     ...
     */
    public static final Tuple ALIVE_TUPLE_TEMPLATE = new Tuple(AgentProtocol.COMMAND_LINE, String.class, String.class, String.class, AgentProtocol.ALIVE);
    ...
    public static Tuple getCommandTuple(String agentId, String agentName) {
        Tuple stopTuple = new Tuple(AgentProtocol.COMMAND_LINE, String.class, agentId, agentName, AgentProtocol.MESSAGE_STOP);
        stopTuple.setExpiration(COMMAND_EXPIRATION);
        return stopTuple;
    }
    ...
    public static Tuple getIdentifyTuple(String agentId, String agentName, VMID queryId) {
        Tuple identifyTuple = new Tuple(AgentProtocol.QUERY, queryId.toString(), agentId, agentName, AgentProtocol.MESSAGE_IDENTIFY);
    ...
    public static Tuple getIdentifyTuple(String agentId, String agentName) {
        Tuple identifyTuple = new Tuple(AgentProtocol.QUERY, String.class, agentId, agentName, AgentProtocol.MESSAGE_IDENTIFY);
        identifyTuple.setExpiration(COMMAND_EXPIRATION);
        return identifyTuple;
    }
