...
public abstract class AbstractThreadedAgent extends AbstractAgent implements IThreadedAgent, Callback {
    ...
    /**
     * Really runs the agent. This method is present so programmers can implement their own behavior of agents whenever they should run. It is necessary to provide means that the agent is triggered in doRun.
     * 
