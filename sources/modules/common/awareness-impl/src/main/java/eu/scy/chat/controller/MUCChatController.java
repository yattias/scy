...
public class MUCChatController implements ChatController {
	...
	private static final Logger logger = Logger.getLogger(MUCChatController.class
			.getName());
	...
	public MUCChatController(IAwarenessService awarenessService, String ELOUri) {
		...
		logger.debug("MUC ChatController: awarenessService.isConnected(): "+ awarenessService.isConnected());
		this.ELOUri = ELOUri;
		...
		awarenessService.addAwarenessRosterListener(new IAwarenessRosterListener() {
			...
			public void handleAwarenessRosterEvent(IAwarenessRosterEvent e) {
				...
				for (String address : addresses) {
					...
					if(e.getMessage().equals(IAwarenessRosterEvent.ADD)){
					...
					} else if(e.getMessage().equals(IAwarenessRosterEvent.REMOVE)) {
	...
	protected int getIndexOfBuddy(IAwarenessUser awarenessUser) {
		...
		while (elements.hasMoreElements()) {
			  ...
			  if( auser.getNickName() != null && auser.getNickName().equals(awarenessUser.getNickName())) {
