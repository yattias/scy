...
public class AgentManager implements Callback {
     ...
     *             If something went wrong during the creation of the new agent (e.g. in the process
    ...
    protected void doInjections(IThreadedAgent agent) {
        // to be overriden by domain specific subclasses
    }
     ...
     * @throws AgentLifecycleException
     *             If something went wrong during the killing of this agent this exception is
     *             thrown.
     */
