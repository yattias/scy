 ...
 */
public class AjaxTransferObjectNumberFieldController extends AbstractController {
    ...
    private Boolean executeSetter(BaseXMLTransfer transferObject, String property, Integer value) {
        try {
            ...
            Method method = transferObject.getClass().getMethod("set" + property, Integer.class);
