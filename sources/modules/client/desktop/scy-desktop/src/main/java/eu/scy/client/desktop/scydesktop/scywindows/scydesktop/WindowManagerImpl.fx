...
import eu.scy.client.desktop.scydesktop.EdtChecker;

/**
 * @author sikken
import eu.scy.client.desktop.scydesktop.EdtChecker;j
 */
public class WindowManagerImpl extends WindowManager {
   ...
   public override function addScyWindow(scyWindow: ScyWindow) {
      ...
      EdtChecker.checkIfRunningOnEdt();
...
//         insert scyWindow into scyWindows.content;
         var currentWindows = scyWindows.content;
         insert scyWindow into currentWindows;
         scyWindows.content = currentWindows;
      } else {
