...
class ScyWindowAllInOne extends CustomNode {
   ...
   public var scyDesktop: WindowManager;
	...
	public var minimizeAction: function(ScyWindowAllInOne):Void;
	public var setScyContent: function(ScyWindowAllInOne):Void;
	public var aboutToCloseAction: function(ScyWindowAllInOne):Boolean;
	public var closedAction: function(ScyWindowAllInOne):Void;
