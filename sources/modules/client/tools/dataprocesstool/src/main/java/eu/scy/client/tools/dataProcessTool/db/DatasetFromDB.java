...
public class DatasetFromDB {
    ...
    /* load all dataset (name) from the specified missions*/
    ...
    /* load headers of the specified dataset  */
    ...
    /* load all operations from a specified dataset */
    public static CopexReturn getAllDatasetOperationFromDB(DataBaseCommunication dbC, long dbKeyDs,  TypeOperation[] tabTypeOp, ArrayList v){
        ...
        for (int i=0; i<nbR; i++){
            ...
            // list no col/row on which operation applies
            ArrayList v3 = new ArrayList();
    ...
    /* creation blank dataset - v[0] new dbKey */
    ...
    /* remove dataset from the db: remove operations, data,  headers and links */
    ...
    /* dataset creation -  v[0] : dataset and the new keys*/
    ...
    /* load all visualizations of a specified dataset  */
    ...
    /* load param for a specified fonction model */
    ...
    /* update no col for data,  header, operation, visualization */
    public static CopexReturn updateNoInDB(DataBaseCommunication dbC, Dataset ds){
        ...
        if (cr.isError())
            return cr;
        // list  operations / visualizations : remove and re-create
    ...
    /* update nb rows and nb cols for matrix */
