...
public class ChatNode extends CustomNode, Resizable {
                  ...
                  HBox{
                     ...
                     content:[
                        Button {
                           text: "New"
                           action: function() {
                              //eloChatActionWrapper.newChatAction();
										setScyWindowTitle();
                           }
                        }
                        Button {
                           text: "Load"
                           action: function() {
                              //eloChatActionWrapper.loadChatAction();
										setScyWindowTitle();
                           }
                        }
                        Button {
                           text: "Save"
                           action: function() {
                              //eloChatActionWrapper.saveChatAction();
										setScyWindowTitle();
                           }
                        }
                        Button {
                           text: "Save as"
                           action: function() {
                              //eloChatActionWrapper.saveAsChatAction();
										setScyWindowTitle();
                           }
                        }
                     ]
