...
public class ModellingStandalone_FES_no_pm extends AbstractModellingStandalone implements ActionListener {

	private HashSet<eu.scy.client.tools.scydynamics.logging.TimedEvent> timedEvents;
	
	public ModellingStandalone_FES_no_pm() {
		...
		ModellingLoggerFES actionLogger = new ModellingLoggerFES(fileLogger, getEditor().getUsername(), "exp_no_pm");
	...
	public static void main(String[] args) {
		new ModellingStandalone_FES_no_pm();
	}
