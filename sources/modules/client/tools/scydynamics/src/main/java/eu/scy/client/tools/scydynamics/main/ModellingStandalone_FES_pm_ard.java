...
public class ModellingStandalone_FES_pm_ard extends AbstractModellingStandalone implements ActionListener {

	private HashSet<eu.scy.client.tools.scydynamics.logging.TimedEvent> timedEvents;
	
	public ModellingStandalone_FES_pm_ard() {
	...
	public Properties getProperties() {
		...
		props.put("loadOnStart", "/eu/scy/client/tools/scydynamics/resources/domains/fes/pm_ard.xml");
	...
	public static void main(String[] args) {
		new ModellingStandalone_FES_pm_ard();
	}
