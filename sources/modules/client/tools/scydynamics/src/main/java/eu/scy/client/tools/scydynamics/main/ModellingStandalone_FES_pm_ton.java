...
public class ModellingStandalone_FES_pm_ton extends AbstractModellingStandalone implements ActionListener {

	private HashSet<eu.scy.client.tools.scydynamics.logging.TimedEvent> timedEvents;
	
	public ModellingStandalone_FES_pm_ton() {
		...
		ModellingLoggerFES actionLogger = new ModellingLoggerFES(fileLogger, getEditor().getUsername(), "exp_pm_ton");
	...
	public Properties getProperties() {
		...
		props.put("loadOnStart", "/eu/scy/client/tools/scydynamics/resources/domains/fes/pm_ton.xml");
	...
	public static void main(String[] args) {
		new ModellingStandalone_FES_pm_ton();
	}
