...
public class ModellingStandalone_FES_pm_allconcepts extends AbstractModellingStandalone implements ActionListener {

	private HashSet<eu.scy.client.tools.scydynamics.logging.TimedEvent> timedEvents;
	
	public ModellingStandalone_FES_pm_allconcepts() {
		...
		ModellingLoggerFES actionLogger = new ModellingLoggerFES(fileLogger, getEditor().getUsername(), "exp_pm_ard");
	...
	public Properties getProperties() {
		...
		props.put("loadOnStart", "/eu/scy/client/tools/scydynamics/resources/domains/fes/partial_model_all_concepts_given.xml");
	...
	public static void main(String[] args) {
		new ModellingStandalone_FES_pm_allconcepts();
	}
