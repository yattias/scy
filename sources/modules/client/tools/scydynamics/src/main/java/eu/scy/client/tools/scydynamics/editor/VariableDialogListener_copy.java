...
public class VariableDialogListener_copy extends MouseAdapter implements ActionListener {

	private VariableDialog variableDialog;

	public VariableDialogListener_copy(VariableDialog variableDialog) {
