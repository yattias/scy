...
public class ModellingStandalone_FES_2013_1_epm_sketch extends AbstractModellingStandalone implements ActionListener {

	private HashSet<eu.scy.client.tools.scydynamics.logging.TimedEvent> timedEvents;
	
	public ModellingStandalone_FES_2013_1_epm_sketch() {
		...
		ModellingLoggerFES actionLogger = new ModellingLoggerFES(fileLogger, getEditor().getUsername(), "2013_1_epm_sketch");
	...
	public static void main(String[] args) {
		new ModellingStandalone_FES_2013_1_epm_sketch();
	}
