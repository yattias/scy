...
public class ModellingStandalone_FES_2013_3_simulating_no_pm extends AbstractModellingStandalone implements ActionListener {

	private HashSet<eu.scy.client.tools.scydynamics.logging.TimedEvent> timedEvents;
	
	public ModellingStandalone_FES_2013_3_simulating_no_pm() {
		...
		ModellingLoggerFES actionLogger = new ModellingLoggerFES(fileLogger, getEditor().getUsername(), "2013_3_simulating_no_pm");
	...
	public Properties getProperties() {
		...
		props.put("loadOnStart", "/eu/scy/client/tools/scydynamics/resources/domains/fes/3_simulating_no_pm.xml");

		return props;
	}

	public static void main(String[] args) {
		new ModellingStandalone_FES_2013_3_simulating_no_pm();
	}
