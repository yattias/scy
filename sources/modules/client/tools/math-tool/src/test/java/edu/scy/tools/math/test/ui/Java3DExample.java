...
public class Java3DExample extends  JPanel implements ActionListener {
	  /**
	  ...
	  protected Background createBackground() {
	    Background back = new Background(new Color3f(1f, 1f, 1f));
	  ...
	  public static void main(String[] args) {
	    ...
	    Java3DExample swingTest = new Java3DExample();
