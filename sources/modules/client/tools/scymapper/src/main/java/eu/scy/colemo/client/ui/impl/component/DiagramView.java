...
import eu.scy.colemo.client.ui.impl.component.ConceptLinkView;
import eu.scy.colemo.client.ui.impl.component.LinkView;
import eu.scy.colemo.client.ui.impl.component.NodeView;
import eu.scy.colemo.client.ui.components.ConnectionPoint;
import eu.scy.colemo.client.ui.impl.controller.NodeController;
import eu.scy.colemo.client.ui.impl.controller.LinkConnectorController;
import eu.scy.colemo.client.ui.impl.controller.LinkController;
import eu.scy.colemo.client.ui.impl.model.SimpleLink;
...
public class DiagramView extends JPanel implements IDiagramObserver, INodeObserver {
    ...
    private void initializeGUI() {
        ...
        for (IConceptNode node : model.getNodes()) {
            addNode(node);
        }
