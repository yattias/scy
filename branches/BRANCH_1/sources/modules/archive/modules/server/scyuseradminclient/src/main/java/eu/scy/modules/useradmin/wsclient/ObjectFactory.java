...
public class ObjectFactory {
    ...
    private final static QName _LoginUserResponse_QNAME = new QName("http://www.scy-net.eu/schemas", "loginUserResponse");
    private final static QName _LoginUser_QNAME = new QName("http://www.scy-net.eu/schemas", "loginUser");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.scy-net.eu/schemas", name = "loginUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.scy-net.eu/schemas", name = "loginUser")
