...
public class EloCalculatorWrapper {

	public static final String scyTextType = "scy/text";
    private static final Logger logger = Logger.getLogger(EloCalculatorWrapper.class.getName());
    ...
    public EloCalculatorWrapper(JTextArea textarea) {
    ...
    public void saveCalculatorAction() {
        logger.fine("save text");
        if (elo == null) {
            saveAsCalculatorAction();
        } else {
    ...
    public void saveAsCalculatorAction() {
