...
<tiles:insertDefinition name="default-page">
    <tiles:putAttribute name="main">
        ...
        <script type="text/javascript" src="/webapp/themes/scy/feedback/swfobject.js"></script>
        <script type="text/javascript">
            <!-- For version detection, set to min. required Flash Player version, or 0 (or 0.0.0), for no version detection. -->
            var swfVersionStr = "10.0.0";
            <!-- To use express install, set to playerProductInstall.swf, otherwise the empty string. -->
            var xiSwfUrlStr = "/webapp/themes/scy/feedback/playerProductInstall.swf";
            var flashvars = {};
            ...
            swfobject.embedSWF(
                "/webapp/themes/scy/feedback/index.swf", "flashContent",
                "800", "600",
        ...
        <div id="flashContent">
       	...
       	<noscript>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="800" height="600" id="Main">
                <param name="movie" value="/webapp/themes/scy/feedback/index.swf" />
                <param name="quality" value="high" />
                <param name="bgcolor" value="#ffffff" />
                <param name="allowScriptAccess" value="always" />
                <param name="allowFullScreen" value="true" />
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="/webapp/themes/scy/feedback/index.swf" width="800" height="600">
                    <param name="quality" value="high" />
                    <param name="bgcolor" value="#ffffff" />
                    <param name="allowScriptAccess" value="always" />
                    <param name="allowFullScreen" value="true" />
