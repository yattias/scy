...
/**
 * Provides a keyword extractor for each mimetype. Until now there are extractors defined for
 * <ul>
...
public class KeywordExtractorFactory {
   ...
   * 
   * @param eloType The type of the elo.
   ...
   * 
   * @param eloType The elo type the {@link KeywordExtractor} should work on.
   * @param extractor The extractor that handles elos of the specified type.
   */
