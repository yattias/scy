...
public class ButtonListenerAdapterImpl extends ButtonListenerAdapter {
    ...
    public ButtonListenerAdapterImpl(CreateUser createUserPanel, String buttonName) {
    ...
    public void register() {
        ...
        userManagement.register(username, password, createUserPanel.getUserTitle(), createUserPanel.getFirstName(), createUserPanel.getLastName(), createUserPanel.getDateOfBirth(), createUserPanel.getEmail(), new AsyncCallback<Boolean>() {
                ...
                if (result) {
                    ...
                    Function callback = new Function() {
                        ...
                        public void execute() {
                            ...
                            configFadeIn.setEndOpacity(1);
                            RootPanel.get().clear();
                            Login loginPanel = new Login(username, password);
                            RootPanel.get().add(loginPanel.getCentredLoginDialog());
                            Ext.getBody().fadeIn(configFadeIn);
                        }
                    };
