...
package com.scy.scyDataTool.controller;

import java.util.ArrayList;
import com.copexDataTool.db.*;
...
import com.scy.scyDataTool.pdsELO.BarVisualization;
import com.scy.scyDataTool.pdsELO.GraphVisualization;
import com.scy.scyDataTool.pdsELO.IgnoredData;
import com.scy.scyDataTool.pdsELO.PieVisualization;
...
import com.scy.scyDataTool.utilities.MyConstants;
...
public class ControllerAppletDB implements ControllerInterface{
   ...
   /* retourne un dataset construit à partir d'un ELO dataset */
    ...
    private Dataset getPDS(ProcessedDatasetELO eloPDS, String name){
        ...
        List<com.scy.scyDataTool.pdsELO.Data> listData = ig.getListIgnoredData();
        if (listData != null){
        ...
        List<com.scy.scyDataTool.pdsELO.Operation> listOp = pds.getListOperations();
        for (int i=0; i<listOp.size(); i++){
            com.scy.scyDataTool.pdsELO.Operation op = listOp.get(i);
        ...
        List<com.scy.scyDataTool.pdsELO.Visualization> listVis = pds.getListVisualization();
        for (int i=0; i<listVis.size(); i++){
            com.scy.scyDataTool.pdsELO.Visualization vis = listVis.get(i);
            ...
            if (vis instanceof BarVisualization){
                ...
                List<com.scy.scyDataTool.pdsELO.FunctionModel> lfm = g.getListFunctionModel();
                if (lfm != null){
