...
import eu.scy.agents.roolo.api.IRooloAgentDispatcher;

public class AgentDispatcher<T extends IELO<K>, K extends IMetadataKey> implements IRooloAgentDispatcher<T, K> {
    ...
    @Override
    public void addAfterAgent(IRooloAgent<T, K> agent) {
        afterQueue.add(agent);
    }
    
    @Override
    public void addBeforeAgent(IRooloAgent<T, K> agent) {
        beforeQueue.add(agent);
    }
    
    @Override
    public void addNotificationAgent(IRooloAgent<T, K> agent) {
