...
public class GeneralPanel extends AbstractEloDisplayPanel {
	...
	public GeneralPanel(EloImporterApplication app) {
		...
		this.aggregationLevelPanel.setBorder(BorderFactory.createTitledBorder("Aggregation Level"));
		...
		this.keywordPanel.setBorder(BorderFactory.createTitledBorder("Keywords"));
