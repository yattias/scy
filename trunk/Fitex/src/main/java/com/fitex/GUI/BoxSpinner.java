...
public class BoxSpinner extends javax.swing.JPanel {
    ...
    private void champValeurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_champValeurActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "Le paramètre que vous indiquez n'est pas reconnu comme étant un nombre.");
        } 
    ...
    /** fonction appelée uniquement lors de l'affichage ou du reaffichage du box
     */
     ...
     *  cette fonction est appelée à chaque fois (spinner.getModel ?) que l'utilisateur modifie à la main
     *  la valeur du nombre dans l'editor du spinner (spinner.getEditor) 
     */
    public void majStep(String nombre){
        
        // détermine l'ordre de la dernière décimale
        int ordre = 0 ;
