...
-- alter_column_name Address className classNameId varchar(75);
...
-- alter_column_name EmailAddress className classNameId varchar(75);

alter table Group_ add creatorUserId varchar(75);
-- alter_column_name Group_ className classNameId varchar(75);
...
alter table Layout add css varchar(4000);
...
alter table LayoutSet add css varchar(4000);
...
-- alter_column_name MBDiscussion className classNameId varchar(75);
...
-- alter_column_name Phone className classNameId varchar(75);
...
-- alter_column_name RatingsEntry className classNameId varchar(75);

-- alter_column_name RatingsStats className classNameId varchar(75);
...
-- alter_column_name Role_ className classNameId varchar(75);
...
-- alter_column_name ShoppingCart couponIds couponCodes varchar(75);
...
-- alter_column_name ShoppingOrder couponIds couponCodes varchar(75);
...
-- alter_column_name Subscription className classNameId varchar(75);
...
-- alter_column_name Website className classNameId varchar(75);
