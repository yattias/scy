...
FreestylerImage entry = (FreestylerImage)request.getAttribute("freestylerImage_entry");
...
<form action="<portlet:actionURL windowState="<%= WindowState.MAXIMIZED.toString() %>"><portlet:param name="struts_action" value="/ext/freestyler/edit_entry" /></portlet:actionURL>" method="post" name="<portlet:namespace />fm" onSubmit="<portlet:namespace />saveEntry(); return false;">
...
<tr>
	...
	<td>
		<liferay-ui:input-field model="<%= FreestylerImage.class %>" bean="<%= entry %>" field="name" />
	</td>
</tr>
<tr>
	<td>
