    ...
    <tiles:putAttribute name="main">
       ...
       <link rel="stylesheet" type="text/css" href="http://www.intermedia.uio.no/www-data-public/app-scy/eportfolio/history/history.css" />
        ...
        <script type="text/javascript">
            ...
            swfobject.embedSWF(
                "/webapp/themes/scy/dna/DNA_simulation_no.swf", "flashContent",
                "800", "600",
        ...
        <div id="flashContent" align="center">
       	...
       	<noscript>
               <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1024" height="768" id="index">
                   <param name="movie" value="/webapp/themes/scy/dna/DNA_simulation_no.swf" />
                   <param name="quality" value="high" />
                   <param name="bgcolor" value="#ffffff" />
                   <param name="allowScriptAccess" value="always" />
                   <param name="allowFullScreen" value="true" />
                   <!--[if !IE]>-->
                   <object type="application/x-shockwave-flash" data="/webapp/themes/scy/dna/DNA_simulation_no.swf" width="1024" height="768">
                       <param name="quality" value="high" />
                       <param name="bgcolor" value="#ffffff" />
                       <param name="allowScriptAccess" value="always" />
                       <param name="allowFullScreen" value="true" />
