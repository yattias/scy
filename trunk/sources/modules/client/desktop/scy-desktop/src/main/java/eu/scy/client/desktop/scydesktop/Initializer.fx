...
import eu.scy.client.desktop.desktoputils.InitJavaUtilLogging;
import java.io.File;
...
import eu.scy.client.desktop.desktoputils.SetupLoggingToFiles;
...
import eu.scy.client.desktop.desktoputils.FilteringExceptionCatcher;
