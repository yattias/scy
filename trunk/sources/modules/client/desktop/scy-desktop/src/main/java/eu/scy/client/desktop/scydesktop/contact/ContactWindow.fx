...
import eu.scy.client.desktop.scydesktop.contact.ChatConnector;
import eu.scy.client.desktop.scydesktop.contact.ChatInitiator;
import eu.scy.client.desktop.scydesktop.contact.OnlineState;
import eu.scy.client.desktop.scydesktop.contact.WindowSize;
import eu.scy.client.desktop.scydesktop.scywindows.ScyDesktop;
import eu.scy.client.desktop.scydesktop.scywindows.ScyWindow;
import eu.scy.client.desktop.scydesktop.user.User;
