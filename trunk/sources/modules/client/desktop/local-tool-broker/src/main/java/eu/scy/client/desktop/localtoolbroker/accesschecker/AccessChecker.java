...
public class AccessChecker
{
	...
	private static final String CHARACTERS_HASH_8 = "01234567890ABCDEF"; // need 2^(32/4)=16 characters
	public static final String GENERATOR_HASH_7 = "hash7";
	private static final String CHARACTERS_HASH_7 = "abcdefghijklmnopqrstuvwxyz"; // need 2^(32/7)=24 characters
	public static final String GENERATOR_HASH_6 = "hash6";
	private static final String CHARACTERS_HASH_6 = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNO"; // need 2^(32/6)=41 characters
	public static final String GENERATOR_HASH_5 = "hash5";
	private static final String CHARACTERS_HASH_5 = "abcdefghijkmnopqrstuvwxyzABCDEFGHIJKLMNPQRSTUVWXYZ23456789~!@#$%^&*()_+|-=\\<>?,./[]{}"; // need 2^(32/5)=85 characters
	...
	{
		PasswordChecker newPasswordChecker = passwordCheckers.get(name.toLowerCase());
