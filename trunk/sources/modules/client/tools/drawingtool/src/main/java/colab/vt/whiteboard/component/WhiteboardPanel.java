			...
			MouseListener, MouseWheelListener, KeyListener, Printable
{
   ...
   private long paintCounter = 0;
	...
	{
		if (!whiteboardContainerListChangedListeners
					.contains(whiteboardObjectContainerListChangedListener))
		{
				...
				WhiteboardContainerListChangedListener whiteboardObjectContainerListChangedListener)
	{
		if (whiteboardContainerListChangedListeners
					.contains(whiteboardObjectContainerListChangedListener))
		{
			whiteboardContainerListChangedListeners
						.remove(whiteboardObjectContainerListChangedListener);
		}
	}
				...
				WhiteboardContainerChangedListener whiteboardObjectContainerChangedListener)
	{
		if (!whiteboardContainerChangedListeners.contains(whiteboardObjectContainerChangedListener))
		{
			...
			for (WhiteboardContainer whiteboardContainer : whiteboardContainerList)
				whiteboardContainer
							.addWhiteboardContainerChangedListener(whiteboardObjectContainerChangedListener);
		}
	}
				...
				WhiteboardContainerChangedListener whiteboardObjectContainerChangedListener)
	{
		if (whiteboardContainerChangedListeners.contains(whiteboardObjectContainerChangedListener))
		{
			...
			for (WhiteboardContainer whiteboardContainer : whiteboardContainerList)
				whiteboardContainer
							.removeWhiteboardContainerChangedListener(whiteboardObjectContainerChangedListener);
		}
	}
	...
	public void setTemporaryWhiteboardContainer(WhiteboardContainer whiteboardContainer)
	{
		...
		{
			whiteboardContainerListChangedListener
						.whiteboardContainerAdded(whiteboardContainerListChangedEvent);
		}
		for (WhiteboardContainerChangedListener whiteboardContainerChangedListener : whiteboardContainerChangedListeners)
		{
			whiteboardContainer
						.addWhiteboardContainerChangedListener(whiteboardContainerChangedListener);
		}
	}
				...
				boolean makeFinal)
	{
		...
		else
		{
			...
			{
				whiteboardContainerListChangedListener
							.whiteboardContainerDeleted(whiteboardContainerListChangedEvent);
			}
			for (WhiteboardContainerChangedListener whiteboardContainerChangedListener : whiteboardContainerChangedListeners)
			{
				whiteboardContainer
							.removeWhiteboardContainerChangedListener(whiteboardContainerChangedListener);
			}
		}
	...
	public void deleteAllWhiteboardContainers()
	{
		...
		{
			whiteboardContainerListChangedListener
						.whiteboardContainersCleared(whiteboardContainerListChangedEvent);
		}
	}
...
//      // System.out.println("WhiteboardPanel.paintComponent " + paintCounter);
	...
	public void setStatus(Element status)
	{
		...
		{
			whiteboardContainerListChangedListener
						.whiteboardPanelLoaded(whiteboardContainerListChangedEvent);
		}
	}
	...
	public void setContentStatus(Element status)
	{
		...
		{
			whiteboardContainerListChangedListener
						.whiteboardContainersLoaded(whiteboardContainerListChangedEvent);
		}
	}
