...
public class ModellingStandalone_FES_intro extends AbstractModellingStandalone implements ActionListener {

	private HashSet<eu.scy.client.tools.scydynamics.logging.TimedEvent> timedEvents;
	
	public ModellingStandalone_FES_intro() {
		...
		ModellingLoggerFES actionLogger = new ModellingLoggerFES(fileLogger, getEditor().getUsername(), "intro");
	...
	public Properties getProperties() {
		...
		props.put("editor.reference_model", "/eu/scy/client/tools/scydynamics/resources/domains/fes/intro_reference_model.xml");
		props.put("editor.concept_set", "/eu/scy/client/tools/scydynamics/resources/domains/fes/intro_concept_set.xml");
		props.put("editor.simulation_settings", "/eu/scy/client/tools/scydynamics/resources/domains/fes/intro_simulation_settings.xml");

		//props.put("loadOnStart", "/eu/scy/client/tools/scydynamics/resources/domains/fes_intro/intro_model_qualitative.xml");
	...
	public static void main(String[] args) {
		new ModellingStandalone_FES_intro();
	}
