...
public class ModellingStandalone_FES_2013_2_opm_quali extends AbstractModellingStandalone implements ActionListener {

	private HashSet<eu.scy.client.tools.scydynamics.logging.TimedEvent> timedEvents;
	
	public ModellingStandalone_FES_2013_2_opm_quali() {
		...
		ModellingLoggerFES actionLogger = new ModellingLoggerFES(fileLogger, getEditor().getUsername(), "2013_2_opm_quali");
	...
	public Properties getProperties() {
		...
		props.put("loadOnStart", "/eu/scy/client/tools/scydynamics/resources/domains/fes/2_opm.xml");

		return props;
	}

	public static void main(String[] args) {
		new ModellingStandalone_FES_2013_2_opm_quali();
	}
