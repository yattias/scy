...
public class SimquestModelQualitative extends Element {
	...
	public SimquestModelQualitative(Model model) {
		this(model, new HashMap<String, Double>());
	}

	public SimquestModelQualitative(Model model, HashMap<String, Double> simulationValues) {
		super("model");
		this.model = model;
