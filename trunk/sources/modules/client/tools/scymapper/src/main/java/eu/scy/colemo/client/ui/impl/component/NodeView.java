...
public class NodeView extends JComponent implements INodeObserver, KeyListener {
    ...
    public NodeView(INodeController controller, IConceptNode model) {
    ...
    public IConceptNode getModel() {
        return model;
    }

    public void setModel(IConceptNode model) {
        this.model = model;
    }

    @Override
    public void moved(IConceptNode model) {
        setLocation(model.getLocation());
    }

    @Override
    public void resized(IConceptNode model) {
        setSize(model.getSize());
        layoutComponents();
    }
    ...
    public void paint(Graphics g) {
        ...
        ConceptShape shape = model.getShape();
        if (shape != null) {
            if (style.getFillStyle() == INodeStyle.FILLSTYLE_FILLED)
                shape.setMode(ConceptShape.FILL);
            else
                shape.setMode(ConceptShape.DRAW);
