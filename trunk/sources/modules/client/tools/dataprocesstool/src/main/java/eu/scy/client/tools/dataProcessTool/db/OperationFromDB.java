...
public class OperationFromDB {
    ...
    /* creation new operation - v[0] new id*/
    ...
    /*remove no col for specified operations:  list<list>: long dbKeyOp, int no */
