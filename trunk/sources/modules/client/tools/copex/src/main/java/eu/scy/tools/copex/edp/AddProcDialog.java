 ...
 * permet à l'utlisateur de choisir entre :
 * - creer un nouveau protocole, 
 * - creer un nouveau protocole à partir d'un protocole existant
   ...
   private void selectInitProc(){
    ...
    private void validDialog(){
        ...
        if (this.rbNewProc.isSelected()){
            ...
            // on recupere le protocole à copier
            ...
            // on recupere la mission et le protocole selectionné
...
private void cbListMissionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbListMissionActionPerformed
    // mise à jour de la liste des protocoles en fonction de la mission choisie
