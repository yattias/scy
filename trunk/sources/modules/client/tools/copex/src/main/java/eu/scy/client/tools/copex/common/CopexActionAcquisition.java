...
public class CopexActionAcquisition extends CopexActionParam{
    ...
    public CopexActionAcquisition(long dbKey, List<LocalText> listName, List<LocalText> listDescription, List<LocalText> listComments, String taskImage, Element draw, boolean isVisible, TaskRight taskRight, long dbkeyBrother, long dbKeyChild, InitialNamedAction namedAction, Object[] tabParam, ArrayList<Object> listDataProd, TaskRepeat taskRepeat) {
    ...
    public CopexActionAcquisition(long dbKey, List<LocalText> listName, List<LocalText> listDescription, List<LocalText> listComments, String taskImage, Element draw, boolean isVisible, TaskRight taskRight, InitialNamedAction namedAction, Object[] tabParam, ArrayList<Object> listDataProd, TaskRepeat taskRepeat) {
        super(dbKey, listName, listDescription, listComments, taskImage,draw,  isVisible, taskRight, namedAction, tabParam, taskRepeat);
        this.listDataProd = listDataProd;
    }

    public CopexActionAcquisition(long dbKey, Locale locale, String name, String description, String comment, String taskImage, Element draw, boolean isVisible, TaskRight taskRight, InitialNamedAction namedAction, Object[] tabParam, ArrayList<Object> listDataProd, TaskRepeat taskRepeat) {
        ...
        if (xmlElem.getName().equals(TAG_ACTION_ACQUISITION)) {
            ...
            for (Iterator<Element> variableElem = xmlElem.getChildren().iterator();variableElem.hasNext();){
                ...
                if(e.getName().equals(Quantity.TAG_PARAMETER)){
                    ...
                    listDataProd.add(d);
                }else if(e.getName().equals(TAG_ACTION_ACQUISITION_LIST_DATA_PROD)){
    ...
    public Element toXML(){
        Element element = super.toXML(new Element(TAG_ACTION_ACQUISITION));
        ...
        for(Iterator<Object> d=listDataProd.iterator();d.hasNext();){
            ...
            if(o instanceof QData){
                ...
                Element e = new Element(TAG_ACTION_ACQUISITION_LIST_DATA_PROD);
