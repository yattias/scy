...
public class CopexActionTreatment extends CopexActionParam{
    ...
    //CONSTRUCTOR
    public CopexActionTreatment(String description, String comments, InitialNamedAction namedAction, ActionParam[] tabParam, ArrayList<QData> listDataProd) {
        super(description, comments, namedAction, tabParam);
        this.listDataProd = listDataProd;
    }

    public CopexActionTreatment(long dbKey, String name, String description, String comments, String taskImage, Element draw, boolean isVisible, TaskRight taskRight, long dbkeyBrother, long dbKeyChild, InitialNamedAction namedAction, ActionParam[] tabParam, ArrayList<QData> listDataProd, TaskRepeat taskRepeat) {
    ...
    public CopexActionTreatment(long dbKey, String name, String description, String comments, String taskImage, Element draw, boolean isVisible, TaskRight taskRight, InitialNamedAction namedAction, ActionParam[] tabParam, ArrayList<QData> listDataProd, TaskRepeat taskRepeat) {
    ...
    public String toDescription(EdPPanel edP) {
        ...
        for (int i=0; i<nbDataProd; i++){
            s += "\n "+((InitialActionTreatment)this.namedAction).getListOutput().get(i).getTextProd()+" : "+listDataProd.get(i).getName();
        }
        return s;
    }
