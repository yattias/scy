...
/**
 * refaire : editer une tache
 * @author MBO
 */
public class RedoEditTaskAction extends RedoAction{
    // ATTRIBUTS
    /* tache modifiee */
    ...
    // CONSTRUCTEURS
    public RedoEditTaskAction(long dbkeyProc, String procName, UpdateTaskAction updateTaskAction){
