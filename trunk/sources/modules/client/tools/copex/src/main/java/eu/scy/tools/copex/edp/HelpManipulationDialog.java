...
public class HelpManipulationDialog extends javax.swing.JDialog {
    ...
    */
    ...
    private void initGUI(){
        ...
        int w = labelEnd.getX()+labelEnd.getWidth()+10;
        // ajout du bouton ok
        getButtonOk();
        x = (w-buttonOk.getWidth()) / 2 ;
        this.buttonOk.setBounds(x,label1.getY()+label1.getHeight()+20, buttonOk.getWidth(), buttonOk.getHeight());
