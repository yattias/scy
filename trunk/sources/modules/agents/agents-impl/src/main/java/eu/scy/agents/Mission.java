...
public enum Mission {
    ...
    MISSION4_FRENCH("http://www.scy.eu/forensic#", "Le laboratoire de police scientifique", "mission4", "forensic"),
    GMO("http://www.scy.eu/forensic#", "GMO mission", "mission4", "forensic"),
