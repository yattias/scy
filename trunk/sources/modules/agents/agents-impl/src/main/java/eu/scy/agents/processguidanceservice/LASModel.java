...
public class LASModel extends AbstractGuidanceObject {
    ...
    /*
     * public ELOModel[] getInputELOModels() { return inputELOModels; }
     * 
     * public void addInputELOModel(ELOModel elo) { ELOModel[] newELOModels = (ELOModel[])
     * Arrays.copyOf(inputELOModels, inputELOModels.length + 1); newELOModels[newELOModels.length -
     * 1] = elo; inputELOModels = newELOModels; }
     */
