...
public class CMEnricherAgent extends AbstractThreadedAgent {
    ...
    public CMEnricherAgent(Map<String, Object> map) {
        ...
        try {
            ...
            actionSpace.eventRegister(Command.WRITE, new Tuple("action", String.class, Long.class, Field.createSemiformalField("*_help_requested"), String.class, "conceptmap", String.class, String.class, String.class), cb, true);
