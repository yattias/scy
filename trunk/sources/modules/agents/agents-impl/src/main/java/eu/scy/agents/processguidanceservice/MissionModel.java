...
public class MissionModel extends AbstractGuidanceObject {
    ...
    public void buildPizzaMission() {
        ...
        ELOModel aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/239.239#0", "My Optimized Healthy Pizza", "scy/simconfig");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/237.237#0", "My Favourite Pizza", "scy/simconfig");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/238.238#0", "My First Healthy Pizza", "scy/simconfig");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
        ...
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/249.249#0", "My Health Passport", "scy/resultcard");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/204.204#0", "Food And Exercise Diary", "scy/pds");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/205.205#0", "Daily Calorie Intake", "scy/pds");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/232.232#0", "Evaluate Your Diet (Health Passport)", "scy/rtf");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/233.233#0", "Basal Metabolic Rate (Health Passport)", "scy/rtf");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/234.234#0", "Body Mass Index (Health Passport)", "scy/rtf");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/235.235#0", "Heart Rate (Health Passport)", "scy/rtf");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/208.208#0", "Estimated Energy Requirements (Health Passport)", "scy/pds");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
        ...
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/213.213#0", "Questions About Pizza Benefits", "scy/rtf");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/212.212#0", "Notes On Unhealthy Diet", "scy/rtf");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
        ...
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/255.255#0", "Nutrient And Energy Calculations", "scy/rtf");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/214.214#0", "Nutrition Table", "scy/pds");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/216.216#0", "Pizza Ingredient Table", "scy/pds");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
        ...
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/218.218#0", "Construction Of The Food Pyramid", "scy/model");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/217.217#0", "Questions About The Food Pyramid", "scy/rtf");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
        ...
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/219.219#0", "Energy Fact Sheet", "scy/mapping");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
        ...
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/248.248#0", "mapOfDigestiveSystem", "scy/drawing");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/221.221#0", "Fact Sheet Of One Organ", "scy/rtf");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
        ...
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/222.222#0", "Personal Comments", "scy/rtf");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
        ...
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/227.227#0", "Criteria Final Table", "scy/pds");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/223.223#0", "Methodology Steps", "scy/xproc");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/224.224#0", "Reflection On Importance Of Criteria", "scy/rtf");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/225.225#0", "Criteria Table", "scy/pds");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/226.226#0", "Criteria Weight Table", "scy/pds");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
        ...
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/231.231#0", "Letter To School Canteen", "scy/rtf");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/228.228#0", "Individual Report", "scy/rtf");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/229.229#0", "Group Report", "scy/rtf");
        aLAS.addIntermediateELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
        ...
        aELO = new ELOModel(commandSpace, guidanceSpace, "roolo://scy.collide.info/scy-collide-server/230.230#0", "Taste Scores", "scy/pds");
        aLAS.setMainAnchorELOModel(aELO);
        aELO.setLASModel(aLAS);
        addELOModel(aELO);
        addLASModel(aLAS);
