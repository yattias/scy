...
public class ExtractKeyphrasesAgent extends AbstractRequestAgent {
  ...
  public ExtractKeyphrasesAgent(Map<String, Object> params) {
    ...
    activationTuple = new Tuple(EXTRACT_KEYPHRASES, AgentProtocol.QUERY, String.class, String.class);
  ...
  private Set<String> extractKeyphrases(String text) {
    ...
    HashMap keyphraseMap = (HashMap<String, Float>) doc.getFeature(WikiFeatures.NGRAM_FREQUENCIES);
