...
//			actionSpace = new TupleSpace(new User("test"), "localhost", 2525, false, false, AgentProtocol.ACTION_SPACE_NAME);
			...
			// <Key=Value>:String*)
			Tuple t1 = new Tuple(
					"action", new VMID().toString(), System.currentTimeMillis(), "search-query", "Chris", "scy-search", 
					"mission1", "N/A",	"n/a", 
					"query=jan report test", "eloURIs=roolo://memory/1/0/eloUri.scysim roolo://memory/1/0/eloUri.scymapper");
