...
public class ExtractTopicModelKeywordsAgentTest extends AbstractTestFixture {
  ...
  public void tearDown() throws AgentLifecycleException {
    try {
      getCommandSpace().take(new Tuple("persistent_storage_1_0",
  ...
  public void testRun() throws TupleSpaceException {
    ...
    getCommandSpace().write(new Tuple(ExtractTopicModelKeywordsAgent.EXTRACT_TOPIC_MODEL_KEYWORDS,
    ...
    assertEquals("wrong keywords", "nontoxic;paint;health;natural;", keywords);
  }
}
