...
public class HypothesisEvaluationTest extends AbstractTestFixture {
    ...
    public void testRun() throws TupleSpaceException, IOException,
        ...
        getActionSpace().write(login("testUser", "roolo://memory/0/0/Design+a+CO2-friendly+house.scymissionspecification",
        ...
        Tuple response = this.getCommandSpace().waitToTake(
                new Tuple(HypothesisEvaluationAgent.EVAL, String.class,
                        ...
                        Field.createWildCardField()), AgentProtocol.MINUTE * 1);
