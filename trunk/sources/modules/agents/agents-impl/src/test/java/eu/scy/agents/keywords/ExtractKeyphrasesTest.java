...
public class ExtractKeyphrasesTest extends AbstractTestFixture {
	...
	public void setUp() throws Exception {
		...
		agentMap.put(ExtractKeyphrasesAgent.NAME, params);
	...
	public void testRun() throws TupleSpaceException {
		...
		Tuple query = new Tuple(ExtractKeyphrasesAgent.EXTRACT_KEYPHRASES,
				AgentProtocol.QUERY, queryId.toString(), TEXT, MISSION, LANGUAGE);
		getCommandSpace().write(query);
		System.out.println(query.toString());
		Tuple response = getCommandSpace().waitToRead(
				new Tuple(ExtractKeyphrasesAgent.EXTRACT_KEYPHRASES,
