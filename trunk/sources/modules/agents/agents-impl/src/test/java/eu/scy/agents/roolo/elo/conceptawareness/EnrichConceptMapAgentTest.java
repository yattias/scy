...
public class EnrichConceptMapAgentTest extends ConceptMapAgentsTestFixture {
    ...
    public void setUp() throws Exception {
        ...
        map.put("id", agentId);
        agent = new EnrichConceptMapAgent<IELO<IMetadataKey>, IMetadataKey>(map);
    ...
    public void testProcessElo() {
        ...
        IMetadataValueContainer nodeLabelsContainer = elo.getMetadata().getMetadataValueContainer(typeManager.getMetadataKey("nodeLabel"));
        ...
        IMetadataValueContainer linkLabelsContainer = elo.getMetadata().getMetadataValueContainer(typeManager.getMetadataKey("linkLabel"));
