...
public class ExtractKeywordsTest extends AbstractTestFixture {
  ...
  String[] expectedKeywords = new String[] { "binder", "solvent", "voc", "natural paints",
                                            "modern paints", "ingredients", "nontoxic",
                                            "Natural paints", "Environmentally Friendly", "toxic",
                                            "chemical", "conventional paint companies",
                                            "conventional paint", "non-toxic paints",
                                            "VOC content", "used as solvent", "labels", "paint",
                                            "natural paint", "health", "chemical paints",
                                            "paint companies", "still contain", "natural",
                                            "pigment" };
