...
public class MainInterface extends javax.swing.JFrame {
    ...
    /* met les images sur les rb de couleurs */
    private void setRbIcons(){
        bleu.setIcon(getFitexIcon("bleu_up.gif"));
        bleu.setSelectedIcon(getFitexIcon("bleu_dn.gif"));
        vert.setIcon(getFitexIcon("vert_up.gif"));
        vert.setSelectedIcon(getFitexIcon("vert_dn.gif"));
        noir.setIcon(getFitexIcon("noir_up.gif"));
        noir.setSelectedIcon(getFitexIcon("noir_dn.gif"));
        functionSelector.setIcon(getFitexIcon("dn_big.gif"));
    }

    /* renvoie les icones */
    private Icon getFitexIcon(String img){
        ImageIcon imgIcon = new ImageIcon(getClass().getResource( "/" +img));
        if (imgIcon == null){
            System.out.println("image icon null");
            return null;
        }else
            return imgIcon;
    }
