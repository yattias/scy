 ...
 *
 * @author MBO
 * permet de représenter une erreur ou un warning dans COPEX
 * String text : le texte de l'erreur 
 * boolean ok : à true si aucune erreur
 * boolean warning : à true si il s'agit d'un warning
 * boolean confirm : à true si l'utilisateur doit confirmer => dans ce cas text contient le message de confirmation
 * boolean okCancel : à true s'il s'agit d'une confirmation OK/Cancel, sinon Oui/Non
 * 
 ...
 * si warning à confirmer : ok=false, text=msg de confirm, warning=true, confirm=true, okCancel=true si Ok/Cancel okCancel=false si Oui/Non
 */
...
// ATTRIBUTS
    ...
    /*
     * retourne true si l'instance représente un warning
     */
