...
public class ObwiousAgent<T extends IELO<K>, K extends IMetadataKey> extends AbstractELOAgent<T, K> {
    ...
    // "/agentdata/obwiousdata/tokens/token",
    ...
    // "/agentdata/obwiousdata/workflow",
    ...
    // }
    //
    // IMetadataValueContainer tokenContainer =
    // elo.getMetadata().getMetadataValueContainer(
    // tokenKey);
    // tokenContainer.setValueList((List<String>)
    // doc.getFeature(Features.TOKENS));
    //
    // IMetadataValueContainer workflowContainer =
    // elo.getMetadata().getMetadataValueContainer(
    // workflowKey);
